...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/11/11 18:05:02 by rickymercur       #+#    #+#             */
/*   Updated: 2024/11/17 19:53:55 by rickymercur      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
1) `read_from_fd`: 
    ...
    This function is responsible for reading data from a file descriptor (`fd`) and storing the result in a dynamically allocated buffer. 
...
2) `get_line`:
    ...
    This function is responsible for extracting a complete line of text from the buffer string.
...
3) `clean_buffer`:
    ...
    This function is responsible for cleaning up the temporary buffer after reading a complete line. 
...
4) `get_next_line`:
    ...
    This function is responsible for reading the next line of text from a file descriptor (`fd`) and 
